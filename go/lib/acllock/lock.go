...
//	    "TASKS_TASK_ADD": 1,
//	    "TASKS_TASK_DELETE": 2,
//	    "TASKS_TASK_SERVICE_BULK_EXPORT": 3
//	  },
//	  "reserved": [4],
//	  "checksum": "sha256:..."
//	}
//
// Permissions is the deterministic ID allocation table. Values are opaque
// integer IDs; new perms get the smallest non-negative integer not already in
// Permissions or Reserved.
//
// Keys are ENUM VALUE NAMES, not cascade codes. The gateway derives a
