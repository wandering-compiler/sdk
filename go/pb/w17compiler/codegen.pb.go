...
type InstallPluginIntent struct {
	...
	// Provenance for a `git`-sourced plugin. Required when source is `git` and
	// refused otherwise — the marker and the coordinates are one fact, and a
	// lock carrying half of it would claim provenance it cannot produce.
	Git           *PluginGitPin `protobuf:"bytes,4,opt,name=git,proto3" json:"git,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InstallPluginIntent) GetGit() *PluginGitPin {
	if x != nil {
		return x.Git
	}
	return nil
...
// PluginGitPin mirrors the lock's own GitPin across the public/private
// boundary. It is a copy rather than an import because this file is the PUBLIC
// contract and the lock's proto is private to the compiler — the same reason
// InstalledPlugin exists beside the lock's PluginInstall. The two must stay in
// step; the server converts between them in one place (applyInstallPlugin).
//
// Why three values and not just the tag: a tag is a movable pointer, the
// commit is immutable but only resolvable through git, and the digest is what
// survives the clone, the copy into the project and the commit into the
// consumer's repo — the bytes that will actually be compiled. See the lock
// proto's GitPin for the full account.
type PluginGitPin struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PluginGitPin) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PluginGitPin) GetRef() string {
	if x != nil {
		return x.Ref
	}
	return ""
...
func (x *PluginGitPin) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
func (x *PluginGitPin) GetDigest() string {
	if x != nil {
		return x.Digest
	}
	return ""
...
type PluginVersion struct {
	...
	Version string                 `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`
	Source  string                 `protobuf:"bytes,3,opt,name=source,proto3" json:"source,omitempty"`
	// The NEW provenance, when an update moves a plugin to another published
	// version. Carrying the version without it would leave the previous pin in
	// place beside a new version number — a lock that passes validation and
	// names bytes nobody fetched.
	Git           *PluginGitPin `protobuf:"bytes,4,opt,name=git,proto3" json:"git,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PluginVersion) GetGit() *PluginGitPin {
	if x != nil {
		return x.Git
	}
	return nil
...
const file_w17compiler_codegen_proto_rawDesc = "" +
	...
	"\aw17_url\x18\x03 \x01(\tR\x06w17Url\"\x90\x01\n" +
	"\x13InstallPluginIntent\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x16\n" +
	"\x06source\x18\x03 \x01(\tR\x06source\x123\n" +
	"\x03git\x18\x04 \x01(\v2!.w17.storage.codegen.PluginGitPinR\x03git\"d\n" +
	"\fPluginGitPin\x12\x12\n" +
	...
	"\aplugins\x18\x01 \x03(\v2\".w17.storage.codegen.PluginVersionR\aplugins\"\x8a\x01\n" +
	"\rPluginVersion\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\x16\n" +
	"\x06source\x18\x03 \x01(\tR\x06source\x123\n" +
	"\x03git\x18\x04 \x01(\v2!.w17.storage.codegen.PluginGitPinR\x03git\"k\n" +
